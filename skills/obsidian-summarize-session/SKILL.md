---
name: obsidian-summarize-session
description: Summarize the current AI coding session and export it as an Obsidian note
---

# Obsidian Summarize Session

Summarize everything done in the current AI coding session and save as an Obsidian note.
...
5. **Auto-commit and push to the Obsidian repo**
   ...
   - `git commit -m "Add session summary: <date>"` with `Assisted-by: <current AI tool and model>`
