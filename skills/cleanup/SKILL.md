...
WARNING: This will permanently delete all local branches except main.
...
Claude: Checking for uncommitted changes... None found.
        ...
        WARNING: This will permanently delete 4 local branches.
...
Claude: You have uncommitted changes on branch 'feature-xyz'.
        ...
        WARNING: This will permanently delete 3 local branches.
        Are you sure you want to continue?
        [User selects: Yes, delete all branches]
